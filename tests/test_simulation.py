...
from .utils import make_queue_top_model_with_events, empty_coupled
...
def test_top_model_and_events_of_simulation_are_immutable():
    a_model, events = make_queue_top_model_with_events()
    a_simulation = Simulation(top_model=a_model,
                              events=events)
...
def test_simulation_options_are_immutable():
    a_model, events = make_queue_top_model_with_events()
